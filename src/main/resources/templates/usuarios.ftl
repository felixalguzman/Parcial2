        ...
        <a>
            <div class="media">
                ...
                <div class="media_body">
                    ...
                    <form method="post" name="form" action="/usuario/admin/${usuario.id}">
                        <input type="text" id="id" name="id" value="${usuario.id}" hidden>
                        <#if !usuario.admin>
                               <div class="btn_group">
                                   <button type="submit" id="cambio" class="waves-effect btn post">Hacer administrador
                                   </button>
                               </div>
                        </#if>
...
<div class="pagination_area">
    <ul class="pagination" style="text-align: center">
                    <#if actual gt 1>
                        <li class="page-item">
                            <a id="atras" data-ruta="/usuarios/${actual - 1}" class="waves-effect">&larr;</a>
                        </li>
                    ...
                    <#if paginas gt actual>
                       <li class="page-item">
                           <a id="adelante" data-ruta="/usuarios/${actual + 1}" class="waves-effect">&rarr;</a>
                       </li>
                    <#else>
